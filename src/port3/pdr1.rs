...
pub type Pd8W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, Pd8>;
...
pub type Pd9W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, Pd9>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn sd_soe_alt(self) -> &'a mut crate::W<REG> {
        self.variant(Pd9::SdSoeAlt)
    }
    #[doc = "A1+ strong driver, slow edge (alternate value)"]
    #[inline(always)]
    pub fn sd_sle_alt(self) -> &'a mut crate::W<REG> {
        self.variant(Pd9::SdSleAlt)
    }
    #[doc = "A1+ medium driver (alternate value)"]
    #[inline(always)]
    pub fn md_alt(self) -> &'a mut crate::W<REG> {
        self.variant(Pd9::MdAlt)
    }
    #[doc = "A1+ weak driver (alternate value)"]
    #[inline(always)]
    pub fn wd_alt(self) -> &'a mut crate::W<REG> {
        self.variant(Pd9::WdAlt)
    }
}
...
pub type Pd10W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, Pd10>;
...
pub type Pd11W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, Pd11>;
...
pub type Pd14W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, Pd14>;
...
pub type Pd15W<'a, REG> = crate::FieldWriterSafe<'a, REG, 3, Pd15>;
