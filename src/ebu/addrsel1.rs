...
pub type R = crate::R<Addrsel1Spec>;
#[doc = "Register `ADDRSEL1` writer"]
pub type W = crate::W<Addrsel1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn regenab(&mut self) -> RegenabW<Addrsel1Spec> {
        RegenabW::new(self, 0)
    }
    #[doc = "Bit 1 - Alternate Region Enable"]
    #[inline(always)]
    #[must_use]
    pub fn altenab(&mut self) -> AltenabW<Addrsel1Spec> {
        AltenabW::new(self, 1)
    }
    #[doc = "Bit 2 - Memory Region Write Protect"]
    #[inline(always)]
    #[must_use]
    pub fn wprot(&mut self) -> WprotW<Addrsel1Spec> {
        WprotW::new(self, 2)
    }
}
...
pub struct Addrsel1Spec;
impl crate::RegisterSpec for Addrsel1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`addrsel1::R`](R) reader structure"]
impl crate::Readable for Addrsel1Spec {}
#[doc = "`write(|w| ..)` method takes [`addrsel1::W`](W) writer structure"]
impl crate::Writable for Addrsel1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADDRSEL1 to value 0"]
impl crate::Resettable for Addrsel1Spec {
