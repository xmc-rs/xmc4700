...
pub type R = crate::R<Addrsel0Spec>;
#[doc = "Register `ADDRSEL0` writer"]
pub type W = crate::W<Addrsel0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn regenab(&mut self) -> RegenabW<Addrsel0Spec> {
        RegenabW::new(self, 0)
    }
    #[doc = "Bit 1 - Alternate Region Enable"]
    #[inline(always)]
    #[must_use]
    pub fn altenab(&mut self) -> AltenabW<Addrsel0Spec> {
        AltenabW::new(self, 1)
    }
    #[doc = "Bit 2 - Memory Region Write Protect"]
    #[inline(always)]
    #[must_use]
    pub fn wprot(&mut self) -> WprotW<Addrsel0Spec> {
        WprotW::new(self, 2)
    }
}
...
pub struct Addrsel0Spec;
impl crate::RegisterSpec for Addrsel0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`addrsel0::R`](R) reader structure"]
impl crate::Readable for Addrsel0Spec {}
#[doc = "`write(|w| ..)` method takes [`addrsel0::W`](W) writer structure"]
impl crate::Writable for Addrsel0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADDRSEL0 to value 0"]
impl crate::Resettable for Addrsel0Spec {
