...
impl W {
    #[doc = "Bits 0:2 - Burst Length for Synchronous Burst"]
    #[inline(always)]
    pub fn fetblen(&mut self) -> FETBLEN_W<'_, BUSRCON0_SPEC> {
        FETBLEN_W::new(self, 0)
    }
    #[doc = "Bit 3 - Synchronous burst buffer mode select"]
    #[inline(always)]
    pub fn fbbmsel(&mut self) -> FBBMSEL_W<'_, BUSRCON0_SPEC> {
        FBBMSEL_W::new(self, 3)
    }
    #[doc = "Bit 4 - Read Single Stage Synchronization:"]
    #[inline(always)]
    pub fn bfsss(&mut self) -> BFSSS_W<'_, BUSRCON0_SPEC> {
        BFSSS_W::new(self, 4)
    }
    #[doc = "Bit 5 - Burst FLASH Clock Feedback Enable"]
    #[inline(always)]
    pub fn fdbken(&mut self) -> FDBKEN_W<'_, BUSRCON0_SPEC> {
        FDBKEN_W::new(self, 5)
    }
    #[doc = "Bit 6 - Burst Flash Clock Mode Select"]
    #[inline(always)]
    pub fn bfcmsel(&mut self) -> BFCMSEL_W<'_, BUSRCON0_SPEC> {
        BFCMSEL_W::new(self, 6)
    }
    #[doc = "Bit 7 - Enable flash non-array access workaround"]
    #[inline(always)]
    pub fn naa(&mut self) -> NAA_W<'_, BUSRCON0_SPEC> {
        NAA_W::new(self, 7)
    }
    #[doc = "Bit 16 - Early Chip Select for Synchronous Burst"]
    #[inline(always)]
    pub fn ecse(&mut self) -> ECSE_W<'_, BUSRCON0_SPEC> {
        ECSE_W::new(self, 16)
    }
    #[doc = "Bit 17 - Early Burst Signal Enable for Synchronous Burst"]
    #[inline(always)]
    pub fn ebse(&mut self) -> EBSE_W<'_, BUSRCON0_SPEC> {
        EBSE_W::new(self, 17)
    }
    #[doc = "Bit 18 - Disable Burst Address Wrapping"]
    #[inline(always)]
    pub fn dba(&mut self) -> DBA_W<'_, BUSRCON0_SPEC> {
        DBA_W::new(self, 18)
    }
    #[doc = "Bit 19 - Reversed polarity at WAIT"]
    #[inline(always)]
    pub fn waitinv(&mut self) -> WAITINV_W<'_, BUSRCON0_SPEC> {
        WAITINV_W::new(self, 19)
    }
    #[doc = "Bits 20:21 - Byte Control Signal Control"]
    #[inline(always)]
    pub fn bcgen(&mut self) -> BCGEN_W<'_, BUSRCON0_SPEC> {
        BCGEN_W::new(self, 20)
    }
    #[doc = "Bits 22:23 - Device Addressing Mode"]
    #[inline(always)]
    pub fn portw(&mut self) -> PORTW_W<'_, BUSRCON0_SPEC> {
        PORTW_W::new(self, 22)
    }
    #[doc = "Bits 24:25 - External Wait Control: 0=OFF (default after reset)., 1=Asynchronous input at WAIT., 2=Synchronous input at WAIT., 3=reserved., 0=OFF (default after reset)., 1=Wait for page load (Early WAIT)., 2=Wait for page load (WAIT with data)., 3=Abort and retry access.,"]
    #[inline(always)]
    pub fn wait(&mut self) -> WAIT_W<'_, BUSRCON0_SPEC> {
        WAIT_W::new(self, 24)
    }
    #[doc = "Bit 26 - Asynchronous Address phase:"]
    #[inline(always)]
    pub fn aap(&mut self) -> AAP_W<'_, BUSRCON0_SPEC> {
        AAP_W::new(self, 26)
    }
    #[doc = "Bits 28:31 - Device Type for Region"]
    #[inline(always)]
    pub fn agen(&mut self) -> AGEN_W<'_, BUSRCON0_SPEC> {
        AGEN_W::new(self, 28)
    }
}
