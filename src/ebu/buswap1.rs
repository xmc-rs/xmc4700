...
pub type R = crate::R<Buswap1Spec>;
#[doc = "Register `BUSWAP1` writer"]
pub type W = crate::W<Buswap1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wrdtacs(&mut self) -> WrdtacsW<Buswap1Spec> {
        WrdtacsW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Recovery Cycles after Write Accesses"]
    #[inline(always)]
    #[must_use]
    pub fn wrrecovc(&mut self) -> WrrecovcW<Buswap1Spec> {
        WrrecovcW::new(self, 4)
    }
    #[doc = "Bits 7:11 - Programmed Wait States for write accesses"]
    #[inline(always)]
    #[must_use]
    pub fn waitwrc(&mut self) -> WaitwrcW<Buswap1Spec> {
        WaitwrcW::new(self, 7)
    }
    #[doc = "Bits 12:15 - Data Hold Cycles for Write Accesses"]
    #[inline(always)]
    #[must_use]
    pub fn datac(&mut self) -> DatacW<Buswap1Spec> {
        DatacW::new(self, 12)
    }
    #[doc = "Bits 16:17 - Frequency of external clock at pin BFCLKO"]
    #[inline(always)]
    #[must_use]
    pub fn extclock(&mut self) -> ExtclockW<Buswap1Spec> {
        ExtclockW::new(self, 16)
    }
    #[doc = "Bits 18:19 - Extended data"]
    #[inline(always)]
    #[must_use]
    pub fn extdata(&mut self) -> ExtdataW<Buswap1Spec> {
        ExtdataW::new(self, 18)
    }
    #[doc = "Bits 20:23 - Command Delay Cycles"]
    #[inline(always)]
    #[must_use]
    pub fn cmddelay(&mut self) -> CmddelayW<Buswap1Spec> {
        CmddelayW::new(self, 20)
    }
    #[doc = "Bits 24:27 - Address Hold Cycles"]
    #[inline(always)]
    #[must_use]
    pub fn aholdc(&mut self) -> AholdcW<Buswap1Spec> {
        AholdcW::new(self, 24)
    }
    #[doc = "Bits 28:31 - Address Cycles"]
    #[inline(always)]
    #[must_use]
    pub fn addrc(&mut self) -> AddrcW<Buswap1Spec> {
        AddrcW::new(self, 28)
    }
}
