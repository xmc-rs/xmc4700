...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn prstat3(&self) -> &PRSTAT3 {
        &self.prstat3
    }
    #[doc = "0x34 - RCU Peripheral 3 Reset Set"]
    #[inline(always)]
    pub const fn prset3(&self) -> &PRSET3 {
        &self.prset3
    }
    #[doc = "0x38 - RCU Peripheral 3 Reset Clear"]
    #[inline(always)]
    pub const fn prclr3(&self) -> &PRCLR3 {
        &self.prclr3
    }
}
