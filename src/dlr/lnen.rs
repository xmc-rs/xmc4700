...
impl W {
    ...
    #[doc = "Bit 8 - Line 8 Enable"]
    #[inline(always)]
    pub fn ln8(&mut self) -> LN8_W<'_, LNEN_SPEC> {
        LN8_W::new(self, 8)
    }
    #[doc = "Bit 9 - Line 9 Enable"]
    #[inline(always)]
    pub fn ln9(&mut self) -> LN9_W<'_, LNEN_SPEC> {
        LN9_W::new(self, 9)
    }
    #[doc = "Bit 10 - Line 10 Enable"]
    #[inline(always)]
    pub fn ln10(&mut self) -> LN10_W<'_, LNEN_SPEC> {
        LN10_W::new(self, 10)
    }
    #[doc = "Bit 11 - Line 11 Enable"]
    #[inline(always)]
    pub fn ln11(&mut self) -> LN11_W<'_, LNEN_SPEC> {
        LN11_W::new(self, 11)
    }
}
