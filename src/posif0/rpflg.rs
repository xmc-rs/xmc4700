...
impl W {
    ...
    #[inline]
    pub fn rdir(&mut self) -> _RDIRW {
        _RDIRW { w: self }
    }
    #[doc = "Bit 12 - Quadrature period clock flag clear"]
    #[inline]
    pub fn rpclk(&mut self) -> _RPCLKW {
        _RPCLKW { w: self }
    }
}
