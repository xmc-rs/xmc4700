...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eburs(&mut self) -> EbursW<Prset3Spec> {
        EbursW::new(self, 2)
    }
}
...
pub struct Prset3Spec;
impl crate::RegisterSpec for Prset3Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`prset3::W`](W) writer structure"]
impl crate::Writable for Prset3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PRSET3 to value 0"]
impl crate::Resettable for Prset3Spec {
